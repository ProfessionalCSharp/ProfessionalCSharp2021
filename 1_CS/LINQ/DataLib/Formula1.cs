...
namespace DataLib
{
    public static class Formula1
    {
        ...
        private static List<Racer> InitializeRacers() => new()
        {
            ...
            new ("Fernando", "Alonso", "Spain", 318, 32, new int[] { 2005, 2006 }, new string[] { "Renault" }),
            new ("Kimi", "Räikkönen", "Finland", 335, 21 , new int[] { 2007 }, new string[] { "Ferrari" }),
            new ("Lewis", "Hamilton", "UK", 270, 98, new int[] { 2008, 2014, 2015, 2017, 2018, 2019, 2020 }, new string[] { "McLaren", "Mercedes" }),
            new ("Jenson", "Button", "UK", 306, 16, new int[] { 2009 }, new string[] { "Brawn GP" }),
            new ("Sebastian", "Vettel", "Germany", 262, 53, new int[] { 2010, 2011, 2012, 2013 }, new string[] { "Red Bull Racing" }),
        ...
        public static IList<Racer> GetMoreRacers() => _moreRacers ??= new()
        {
            ...
            new Racer("Daniel", "Ricciardo", "Australia", Starts: 192, Wins: 7),
            new Racer("Valtteri", "Bottas", "Finland", Starts: 161, Wins: 9),
            new Racer("Max", "Verstappen", "Netherlands", Starts: 123, Wins: 11)
        };        
    }
}