...
namespace DataLib
{
    public static class Formula1
    {
        ...
        private static List<Racer> InitializeRacers() => new()
        {
            ...
            new("Fernando", "Alonso", "Spain", 321, 32, new int[] { 2005, 2006 }, new string[] { "Renault" }),
            new("Kimi", "Räikkönen", "Finland", 338, 21 , new int[] { 2007 }, new string[] { "Ferrari" }),
            new("Jenson", "Button", "UK", 306, 16, new int[] { 2009 }, new string[] { "Brawn GP" }),
            new("Sebastian", "Vettel", "Germany", 265, 53, new int[] { 2010, 2011, 2012, 2013 }, new string[] { "Red Bull Racing" }),
            new("Nico", "Rosberg", "Germany", 207, 24, new int[] { 2016 }, new string[] { "Mercedes" }),
            new("Lewis", "Hamilton", "UK", 273, 98, new int[] { 2008, 2014, 2015, 2017, 2018, 2019, 2020 }, new string[] { "McLaren", "Mercedes" }),
        };
        ...
        public static IList<Racer> GetMoreRacers() => _moreRacers ??= new()
        {
            ...
            new Racer("Daniel", "Ricciardo", "Australia", Starts: 195, Wins: 7),
            new Racer("Valtteri", "Bottas", "Finland", Starts: 164, Wins: 9),
            new Racer("Max", "Verstappen", "Netherlands", Starts: 126, Wins: 13)
        };        
    }
}