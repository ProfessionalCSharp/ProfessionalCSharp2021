...
public static class Formula1
{
    ...
    private static List<Racer> InitializeRacers() => new()
    {
        ...
        new("Fernando", "Alonso", "Spain", 337, 32, new int[] { 2005, 2006 }, new string[] { "Renault" }),
        ...
        new("Lewis", "Hamilton", "UK", 289, 103, new int[] { 2008, 2014, 2015, 2017, 2018, 2019, 2020 }, new string[] { "McLaren", "Mercedes" }),
        new("Max", "Verstappen", "Netherlands", 142, 20, new int[] { 2021 }, new string[] { "Red Bull Racing" })
    };
    ...
    public static IList<Racer> GetMoreRacers() => _moreRacers ??= new()
    {
        ...
        new Racer("Daniel", "Ricciardo", "Australia", Starts: 211, Wins: 8),
        new Racer("Valtteri", "Bottas", "Finland", Starts: 179, Wins: 10)
    };
}
