...
public static class Formula1
{
    ...
    private static List<Racer> InitializeRacers() => new()
    {
        ...
        new("Sebastian", "Vettel", "Germany", 288, 53, new int[] { 2010, 2011, 2012, 2013 }, new string[] { "Red Bull Racing" }),
        new("Nico", "Rosberg", "Germany", 207, 24, new int[] { 2016 }, new string[] { "Mercedes" }),
        new("Lewis", "Hamilton", "UK", 298, 103, new int[] { 2008, 2014, 2015, 2017, 2018, 2019, 2020 }, new string[] { "McLaren", "Mercedes" }),
        new("Max", "Verstappen", "Netherlands", 151, 26, new int[] { 2021 }, new string[] { "Red Bull Racing" })
    };
    ...
    public static IList<Racer> GetMoreRacers() => _moreRacers ??= new()
    {
        ...
        new Racer("Daniel", "Ricciardo", "Australia", Starts: 220, Wins: 8),
        new Racer("Valtteri", "Bottas", "Finland", Starts: 188, Wins: 10)
    };
}
