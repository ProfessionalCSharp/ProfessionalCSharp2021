...
public static class Formula1
{
    ...
    private static List<Racer> InitializeRacers() => new()
    {
        ...
        new("Fernando", "Alonso", "Spain", 355, 32, new int[] { 2005, 2006 }, new string[] { "Renault" }),
        ...
        new("Lewis", "Hamilton", "UK", 310, 103, new int[] { 2008, 2014, 2015, 2017, 2018, 2019, 2020 }, new string[] { "McLaren", "Mercedes" }),
        new("Max", "Verstappen", "Netherlands", 163, 35, new int[] { 2021, 2022 }, new string[] { "Red Bull Racing" })
    };
    ...
    public static IList<Racer> GetMoreRacers() => s_moreRacers ??= new()
    {
        ...
        new Racer("Valtteri", "Bottas", "Finland", Starts: 200, Wins: 10),
        new Racer("Charles", "Leclerc", "Monaco", Starts: 103, Wins: 5),
        new Racer("Sergio", "Perez", "Mexico", Starts: 236, Wins: 4),
    };
}
