    ...
    public Game CreateGame(GameType gameType, string playerName)
    {
        ...
        static Game<ColorField, SimpleColorResult> Get6x4SimpleGame(GameType gameType, string playerName) =>
            new(
                ...
                4,
                12,
                Enumerable.Range(0, 4).Select(i => new ColorField(GetRandomValue(s_colors6))).ToArray());
        ...
        static Game<ColorField, ColorResult> Get8x5Game(GameType gameType, string playerName) =>
            new(
                ...
                5,
                14,
                Enumerable.Range(0, 5).Select(i => new ColorField(GetRandomValue(s_colors8))).ToArray());
        ...
        static Game<ShapeAndColorField, ShapeAndColorResult> Get5x5x4Game(GameType gameType, string playerName) =>
            new(
                ...
                4,
                14,
                Enumerable.Range(0, 4).Select(i => new ShapeAndColorField(GetRandomValue(s_shapes5), GetRandomValue(s_colors5))).ToArray());
        ...
        return gameType switch
        {
            ...
            _ => throw new GameException("Invalid game type") { HResult = 4000 }
        };
    }
}
