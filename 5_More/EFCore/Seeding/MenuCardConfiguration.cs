...
internal class MenuCardConfiguration(Guid restaurantId) : IEntityTypeConfiguration<MenuCard>
{
    public void Configure(EntityTypeBuilder<MenuCard> builder)
    {
        ...
        builder.HasQueryFilter(m => EF.Property<Guid>(m , RestaurantId) == restaurantId);
    }
}
